        ...
        return (
            <div className={
                ...
                <div className="apt-addheading card-header bg-primary text-white">
                    <FaPlus onClick={this.props.toggleForm}/>
                    Add Appointment
                </div>
                    ...
                    <form id="aptForm" noValidate onSubmit={this.handleAdd}>
                        ...
                        <div className="form-group form-row">
                            ...
                            <div className="col-md-4">
                                <input type="date" className="form-control" name="aptDate" id="aptDate" value={this.state.aptDate} onChange={this.handleChange}/>
                            </div>
                        ...
                        <div className="form-group form-row">
                            ...
                            <div className="col-md-10">
                                <textarea className="form-control" rows="4" cols="50" name="aptNotes" id="aptNotes" placeholder="Appointment Notes" value={this.state.aptNotes} onChange={this.handleChange}/>
                            </div>
                        </div>
